...
# =============================================================================
# Description:
#   Installer script for VedaDB Server on Ubuntu/Debian.
#
#   SECURE INSTALLATION (HIGH-014 fix - recommended):
#     curl -fsSL https://vedadb.io/install.sh -o install.sh
#     curl -fsSL https://vedadb.io/install.sh.sig -o install.sh.sig
...
#
# Usage:
#   # Secure: download, verify signature, then execute
#   curl -fsSL https://vedadb.io/install.sh -o install.sh
#   curl -fsSL https://vedadb.io/install.sh.sig -o install.sh.sig
#   gpg --verify install.sh.sig install.sh && bash install.sh
#
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --help|-h)
            ...
            echo ""
            echo "Usage:"
            echo "  # Secure: download, verify, then execute (HIGH-014 fix)"
            echo "  curl -fsSL https://vedadb.io/install.sh -o install.sh"
            echo "  curl -fsSL https://vedadb.io/install.sh.sig -o install.sh.sig"
            echo "  gpg --verify install.sh.sig install.sh && bash install.sh"
            echo ""
            echo "Options:"
